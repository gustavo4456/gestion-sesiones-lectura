 ...
 * @author gustavo
 */
public class JDialogEditarLecturaLibroTerminado extends javax.swing.JDialog {

    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(JDialogEditarLecturaLibroTerminado.class.getName());
     ...
     */
    public JDialogEditarLecturaLibroTerminado(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();

    }

    public JDialogEditarLecturaLibroTerminado(java.awt.Frame parent, boolean modal, Lectura lectura, Perfil perfil, Lectura lecturaLibroNoLeido) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                JDialogEditarLecturaLibroTerminado dialog = new JDialogEditarLecturaLibroTerminado(new javax.swing.JFrame(), true);
